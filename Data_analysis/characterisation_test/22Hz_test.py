...
force1 = []
displ1 = []
p=Path(__file__).with_name('22Hz_A1.txt')
with p.open('r') as f:
    for line in f:
...
force2 = []
displ2 = []
p=Path(__file__).with_name('22Hz_A2.txt')
with p.open('r') as f:
    for line in f:
...
force3 = []
displ3 = []
p=Path(__file__).with_name('22Hz_A3.txt')
with p.open('r') as f:
    for line in f:
...
force4 = []
displ4 = []
p=Path(__file__).with_name('22Hz_A4.txt')
with p.open('r') as f:
    for line in f:
